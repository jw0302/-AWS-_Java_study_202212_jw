...
--
-- Table structure for table `mento_mst`
--

DROP TABLE IF EXISTS `mento_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mento_mst` (
  `mento_id` int NOT NULL,
  `mento_name` varchar(45) NOT NULL,
  PRIMARY KEY (`mento_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mento_mst`
--

LOCK TABLES `mento_mst` WRITE;
/*!40000 ALTER TABLE `mento_mst` DISABLE KEYS */;
INSERT INTO `mento_mst` VALUES (1,'문자영'),(2,'문성현');
/*!40000 ALTER TABLE `mento_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-19 17:38:36
