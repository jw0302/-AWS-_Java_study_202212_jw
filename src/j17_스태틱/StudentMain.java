...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		students[3] = new Student("윤선영");
		students[4] = new Student("박성진");
...
//		
//		String name = s; 			// string변수 선언에서는 .tostring 필수
//		
//		System.out.println(s); 		// .tostring() 은 생략 가능
...
//		int j = 0;										// 이렇게 만들어서 쓰면 비효율적이다 for문 안에서 쓰고 버릴수 있는 i와 달리 j는 선언한 지점뒤부터 계속 남아있다.
		
		for(Student s : students) {						// for each 문 : 배열의 공간이 있는 배열문에서 사용, but 
